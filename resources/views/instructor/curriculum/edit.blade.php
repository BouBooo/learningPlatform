    ...
    <div class="container">
        <div class="d-flex justify-content-center">
            <div class="col-lg-10 pl-5 ml-5">
                ...
                <form id="form" action="{{ route('curriculum.update', [ 'id' => $course->id, 'section' => $section->id ]) }}" method="POST" enctype="multipart/form-data">
                    @csrf 
                        ...
                        <div class="jumbotron py-3">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                    <input class="form-control" type="file" id="section_video" name="section_video" value="{{ asset("storage/courses_sections/$course->user_id/$section->video") }}"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
